...
//
// Related Topics 哈希表 链表 双指针 👍 2406 👎 0
...
class P_160_IntersectionOfTwoLinkedLists {
    public static void main(String[] args) {
        Solution solution = new P_160_IntersectionOfTwoLinkedLists().new Solution();
    }
    ...
    public class Solution {
        ...
        public ListNode getIntersectionNode00(ListNode headA, ListNode headB) {
