...
public class _039_05_Logic_NumOfMountains {
    // 输入处理
    public static void main(String[] args) {
        ...
        System.out.println(getResultMy(heights));
    }

    public static int getResultMy(int[] heights) {
        int ans = 0;

        for (int i = 0; i < heights.length; i++) {
            int leftHeight = i >= 1 ? heights[i - 1] : 0;
            int rightHeight = i < heights.length - 1 ? heights[i + 1] : 0;
